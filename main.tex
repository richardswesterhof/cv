...
% here I suppose 4pt would be more consistent, but 3 looks more consistent and that's what counts :)
\begin{tabularx}{\linewidth}{p{\hlwmpad} >{\raggedleft\arraybackslash}X@{\hspace{-3pt}}}
% \begin{tabularx}{\linewidth}{p{\hlwmpad} >{\centering\arraybackslash}X}
    \adjustbox{valign=t}{\makecell[l]{
        ...
        {\color{gray} Geboortedatum} \hfill 26-07-1999 \hspace{0.01cm}\\
        {\color{gray} Woonplaats} \hfill Heerenveen \hspace{0.01cm}\\
        {\color{gray} Email} \hfill \email{richardswesterhof@gmail.com} \hspace{0.01cm}\\ 
        {\color{gray} Website} \hfill \href{https://richardswesterhof.github.io}{richardswesterhof.github.io} \hspace{0.01cm}\\
        {\color{gray} LinkedIn} \hfill \href{https://linkedin.com/in/richardswesterhof}{richardswesterhof} \hspace{0.01cm}\\
        {\color{gray} GitHub} \hfill \href{https://github.com/richardswesterhof}{richardswesterhof} \hspace{0.01cm}\\
    }} &
    \adjustbox{valign=t}{
        % code adjusted from https://tex.stackexchange.com/a/511832
        \begin{tikzpicture}
            \clip (0,0)  circle (1.83cm) ;
...
% \hspace{4pt}
\begin{tabularx}{\linewidth}{p{\hlwmpad} X p{\hlwmpad}}
    % for some reason the alignment wasn't quite perfect so I had to use inner tabularx again (and it's still not perfect :()
    {\begin{tabularx}{\linewidth}[t]{l X r@{\hspace{-4pt}}}
